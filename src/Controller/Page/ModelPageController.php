...
{
    #[Route('/{projectShortId<[A-Za-z0-9]{10}>}/models/create', name: 'create', methods: ['GET'])]
    ...
    ): Response
    {
        ...
        $timeParams = $modelService->getDefaultTimeParamsFormData();

        return $this->renderModelPage($request, [
            'project' => $project,
            'model' => $model,
            'modelTab' => 'time_params',
            'timeParamsPageTitle' => 'Создание модели',
            'timeParamsSubmitLabel' => 'Создать модель',
            'timeParams' => $timeParams,
            'timeParamsMode' => 'create',
            'modelTabTimeParamsUrl' => $this->generateUrl('app_model_create', [
                'projectShortId' => $projectShortId,
            ]),
            'timeParamsApiUrl' => $this->generateUrl('api_model_create', [
                'projectShortId' => $projectShortId,
            ]),
            'timeParamsApiMethod' => 'POST',
        ]);
    }
